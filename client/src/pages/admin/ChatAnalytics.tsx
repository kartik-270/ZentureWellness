...
} from "@/components/admin/HolisticCharts";
    ...
    return (
        ...
        >
            <div className="max-w-7xl mx-auto p-4 lg:p-8">
                            ...
                            <div className="space-y-4">
                                <div className="p-4 bg-purple-50 rounded-2xl border border-purple-100">
                                    ...
                                    <p className="text-sm text-gray-700 leading-relaxed">
                                        The radar chart shows <strong>{holisticData?.causesOfStress?.sort((a: any, b: any) => b.A - a.A)[0]?.subject}</strong> as the primary driver of student concern this month.
                                    </p>
                                </div>
                                {loadingHolistic ? (
                ...
                <div className="bg-white/80 backdrop-blur-md p-8 rounded-3xl shadow-sm border border-gray-100 mb-8">
