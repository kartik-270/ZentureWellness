        ...
        <div className="flex h-screen bg-gray-50 relative">
            ...
            <main className="flex-1 overflow-y-auto pt-16 md:pt-0 h-full w-full">
                <div className="p-4 md:p-10 space-y-6 md:space-y-10 max-w-7xl mx-auto">
                    {/* Desktop Header */}
                    <header className="hidden md:flex justify-between items-end pb-8  border-b border-gray-200">
                        <div>
                            <h1 className="text-3xl font-black text-gray-900 flex items-center gap-3 uppercase tracking-tight">
                                {icon && <span className="text-blue-600">{icon}</span>}
                                {title}
                            </h1>
                            <p className="text-gray-500 mt-1 font-medium italic">Manage your practice and support students.</p>
                        </div>
                        <div className="flex items-center space-x-4 bg-white p-2 pr-6 rounded-2xl shadow-sm border border-gray-100">
                            ...
                            <div className="flex flex-col">
                                <span className="text-[10px] text-gray-400 font-black uppercase tracking-widest leading-none mb-1">Counsellor</span>
                                <span className="text-lg font-black text-gray-900 leading-none uppercase tracking-tight">{username}</span>
                            </div>
                        </div>
                    </header>
