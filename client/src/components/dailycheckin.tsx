...
import { Sparkles, BarChart3, Clock, Lock } from "lucide-react";
                    ...
                    {!isLoggedIn ? (
                        <>
                            <div className="flex-1 space-y-4 text-center md:text-left">
                                <div className="inline-flex items-center gap-2 bg-slate-100 px-4 py-2 rounded-full border border-slate-200 text-slate-500 font-bold text-xs uppercase tracking-wider">
                                    <Lock size={14} />
                                    Account Required
                                </div>
                                ...
                                <p className="text-lg text-slate-600 max-w-lg">
                                    Log in to track your daily mood, get personalized wellness insights, and maintain your self-care streak.
                                </p>
                            </div>
                            <div className="flex flex-col gap-3 w-full md:w-auto">
                                ...
                                <p className="text-center text-xs text-slate-400 font-medium italic">
                                    Start your 30-second daily reflection
                                </p>
                            </div>
                        </>
                    ) : (
